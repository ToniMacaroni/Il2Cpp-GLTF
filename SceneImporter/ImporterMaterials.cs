...
// 				}
			...
			var settings = (Enumerable.FirstOrDefault<GLTFImportPluginContext>(Context.Plugins, x => x is MaterialExtensionsImportContext) as MaterialExtensionsImportContext)?.settings;
			var KHR_materials_ior = settings != null && settings.KHR_materials_ior;
			var KHR_materials_transmission = settings != null && settings.KHR_materials_transmission;
			var KHR_materials_volume = settings != null && settings.KHR_materials_volume;
			var KHR_materials_iridescence = settings != null && settings.KHR_materials_iridescence;
			var KHR_materials_specular = settings != null && settings.KHR_materials_specular;
			var KHR_materials_clearcoat = settings != null && settings.KHR_materials_clearcoat;
			var KHR_materials_pbrSpecularGlossiness = settings != null && settings.KHR_materials_pbrSpecularGlossiness;
			var KHR_materials_emissive_strength = settings != null && settings.KHR_materials_emissive_strength;
