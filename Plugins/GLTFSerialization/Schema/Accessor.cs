...
namespace GLTF.Schema
{
	public class Accessor : GLTFChildOfRootProperty
	{
		...
		public static unsafe float3[] AsSparseFloat3Array(Accessor paraAccessor, ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
		...
		public static unsafe float3[] AsSparseFloat3ArrayConversion(Accessor paraAccessor, ref NumericArray contents, void* bufferPointer, float3 conversion, uint offset = 0, bool normalizeIntValues = true)
		{
			var Count = paraAccessor.Sparse.Count;
			var ComponentType = paraAccessor.ComponentType;
		...
		public static unsafe uint[] AsSparseUIntArray(Accessor paraAccessor, ref NumericArray contents, void* bufferPointer, uint offset = 0)
		{
			...
			for (uint idx = 0; idx < paraAccessor.Sparse.Count; idx++)
			{
				if (stride == 1)
				{
					arr[idx] = ((uint*)bufferPointer)[(int)(totalByteOffset + idx)];
				}
				else
				{
		...
		public unsafe uint[] AsUIntArray(ref NumericArray contents, void* bufferPointer, uint offset = 0)
		{
		...
		public unsafe float[] AsFloatArray(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
			if (contents.AsUInts != null)
			{
		...
		public unsafe float2[] AsFloat2Array(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
		...
		public unsafe float2[] AsTexcoordArray(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
			if (contents.AsFloat2s != null)
			{
				return contents.AsFloat2s;
		...
		public unsafe float3[] AsFloat3Array(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
		...
		public unsafe float3[] AsFloat3ArrayConversion(ref NumericArray contents, void* bufferPointer, float3 conversion, uint offset = 0, bool normalizeIntValues = true)
		{
			if (contents.AsFloat3s != null)
			{
				return contents.AsFloat3s;
		...
		public unsafe float4[] AsFloat4Array(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalizeIntValues = true)
		{
		...
		public unsafe float4[] AsFloat4ArrayConversion(ref NumericArray contents, void* bufferPointer, float4 conversion, uint offset = 0, bool normalizeIntValues = true)
		{
			if (contents.AsFloat4s != null)
			{
				return contents.AsFloat4s;
		...
		public unsafe float3[] AsVertexArray(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalized = true)
		{
			if (contents.AsFloat3s != null)
			{
				return contents.AsFloat3s;
			...
			contents.AsFloat3s = AsFloat3ArrayConversion(ref contents, bufferPointer, conversion, offset, normalized);

			return contents.AsFloat3s;
		}

		public unsafe float3[] AsNormalArray(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalized = true)
		{
			if (contents.AsFloat3s != null)
			{
				return contents.AsFloat3s;
		...
		public unsafe float4[] AsTangentArray(ref NumericArray contents, void* bufferPointer, uint offset = 0, bool normalized = true)
		{
			if (contents.AsFloat4s != null)
			{
				return contents.AsFloat4s;
			...
			contents.AsFloat4s = AsFloat4ArrayConversion(ref contents, bufferPointer, conversion, offset, normalized);

			return contents.AsFloat4s;
		}

		public unsafe uint[] AsTriangles(ref NumericArray contents, void* bufferPointer, uint offset = 0)
		{
			...
			contents.AsTriangles = AsUIntArray(ref contents, bufferPointer, offset);
